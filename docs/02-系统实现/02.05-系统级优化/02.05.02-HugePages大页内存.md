...
- [02.05.02 HugePages大页内存](#020502-hugepages大页内存)
  ...
  - [5. Redis配置](#5-redis配置)
    - [5.1 启用HugePages](#51-启用hugepages)
    - [5.2 使用HugePages](#52-使用hugepages)
    - [5.3 验证HugePages使用](#53-验证hugepages使用)
  - [6. 性能测试](#6-性能测试)
    - [6.1 TLB命中率测试](#61-tlb命中率测试)
    - [6.2 内存访问延迟测试](#62-内存访问延迟测试)
  - [7. 优化建议](#7-优化建议)
    - [7.1 内存大小选择](#71-内存大小选择)
    - [7.2 数量配置](#72-数量配置)
    - [7.3 透明大页（THP）](#73-透明大页thp)
  - [8. 注意事项](#8-注意事项)
    - [8.1 内存碎片](#81-内存碎片)
    - [8.2 兼容性](#82-兼容性)
    - [8.3 监控](#83-监控)
